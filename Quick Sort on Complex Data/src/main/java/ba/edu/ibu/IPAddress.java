...
public class IPAddress implements Comparable<IPAddress> {
    ...
    public static IPAddress[] readIP(String path, int numOfRows) throws FileNotFoundException {
        ...
        scanner.close();
        System.out.println("Successfully read file at path: " + path);
        long end = System.currentTimeMillis();
        System.out.println("Elapsed Time for file reading: " + (end-start) + "ms");
        return IPAddresses;
    }
    ...
    public static void writeToFile(String path, IPAddress[] ipAddresses) throws IOException {
        ...
        long end = System.currentTimeMillis();
        System.out.println("Elapsed Time for file writing: " + (end-start) + "ms");
    }
