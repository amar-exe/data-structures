...
public class RedBlackTree<Key extends Comparable<Key>, Value> {
	...
	private static int numOfRed;
	
	/* Retrieve a value associated with a given key */
	public HashMap<Integer, Value> get(Key key) {

		HashMap<Integer, Value> test = new HashMap<>();
		this.numOfSteps = 0;
	...
	public void countRedLinks() {
		numOfRed = 1;
		countRedLinks(root);
		System.out.println("Num of red: " + numOfRed);
	}
